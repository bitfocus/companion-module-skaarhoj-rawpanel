exports.UpdateFeedbacks = async function (self) {
	...
	self.setFeedbackDefinitions({
		tieToHwc: {
			name: 'Generic - Tie HWC Press To This Button',
			description: 'Currently disabled in the module',
		...
		tieToHwc4Way: {
			name: '4-Way/Edge Button - Tie HWC To This Button',
			description: 'Currently disabled in the module',
		...
		tieToHwcJoystick: {
			name: 'Joystick - Tie HWC To This Button',
			description: 'Currently disabled in the module',
		...
		tieToHwcLed: {
			name: 'Tie HWC LED To This Button',
			description: 'Currently disabled in the module',
			...
			callback: function (feedback, bank, info) {
				...
				// 			self.sendCommand(self, 'HWCc#' + feedback.options.hwc + '=128')
				// 			self.sendCommand(self, 'HWC#' + feedback.options.hwc + '=5') // Dimmed
				// 		} else {
				// 			self.sendCommand(self, 'HWC#' + feedback.options.hwc + '=0') // OFF
				// 		}
				// 	} else {
				// 		self.sendCommand(self, 'HWCc#' + feedback.options.hwc + '=' + rgb)
				// 		self.sendCommand(self, 'HWC#' + feedback.options.hwc + '=36') // ON
				// 	}
				// } else {
				// 	self.sendCommand(self, 'HWCc#' + feedback.options.hwc + '=' + rgb)
				// }
		...
		tieToLcd: {
			name: 'Tie HWC LCD/OLED to this Buttons Display',
			description: 'Currently disabled in the module',
